...
class Paddles:
    ...
    def load(self, theme, resolution):
        ...
        # adjust dimensions (widht and height) according to resolution (map in constants.py)
        self.paddles = [Paddle(PADDLE_STARTING_POS, self.screen_width, choice(self.images))]
    ...
    def add_paddle(self, dimension):
        self.paddles.append(Paddle(dimension, self.screen_width, choice(self.paddle_images)))
